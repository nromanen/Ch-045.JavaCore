...
public class PrTask2App {
    ...
    public static void main(String[] args) {
        ...
        String name = PrStringsUtil.readString(scanner, "Enter surname, name and patronymic:");
        try {
           // String name = "  Гаврилюк     ігор    петрович                        ";
            if (!PrStringsUtil.isAlpha(name)) throw new IllegalArgumentException("Invalid surname, name or patronymic");
            name = PrStringsUtil.toCapsWord(name);//deleted spaces
